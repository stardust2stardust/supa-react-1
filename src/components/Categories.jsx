...
const Categories = ({ handleMealSelection, handleShowAllBowls }) => {
  return (
    <>
      <div className="w-full flex justify-center bg-zinc-900 text-zinc-50 md:text-2xl md:gap-4">
        <button
          onClick={handleShowAllBowls}
          className="px-3 py-2 md:py-4 focus:bg-green-700 focus:text-stone-100">
          All
        </button>
        <button
          value="Breakfast"
